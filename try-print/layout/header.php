	...
	<div id="wrapper">
		...
		<nav class="navbar-default navbar-static-top" role="navigation">
			...
			<div class="drop-men" >
				<ul class="nav_1">
					<li class="dropdown">
						<a href="#" class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span class=" name-caret"><?php echo $_SESSION['username'];?><i class="caret"></i></span><img src="assets/images/wo.jpg"></a>
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li>
							<a href="Jurusan.php" class=" hvr-bounce-to-right"><i class="fa fa-list nav_icon "></i><span class="nav-label">Jurusan</span> </a>
						</li>
						<li>
							...
							<ul class="nav nav-second-level collapse">
								<li><a href="print-sertifikat.php" class=" hvr-bounce-to-right"><i class="fa fa-print nav_icon"></i>Print Sertifikat</a></li>
