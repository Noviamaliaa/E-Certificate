		...
		<div class="blank">
			<div class="blank-page">
				...
				<?php
					...
					$result = mysqli_query($connect,"select * FROM sertifikat,mahasiswa where sertifikat.mahasiswa=mahasiswa.nim LIMIT $startrow,10");
					if ($result)
					{
						if ($result->num_rows > 0)
						{
							...
							while ($row = $result->fetch_object())
							{
								...
								echo "<td><a href='records.php?id=" . $row->nomorsertifikat . "'>Edit</a></td>";
								echo "<td><a href='delete.php?id=" . $row->nomorsertifikat . "'>Delete</a></td>";
